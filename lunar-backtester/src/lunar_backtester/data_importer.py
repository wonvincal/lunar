    ...
    def _import_stocks(self, data: List[Dict[str, Any]]) -> None:
        ...
        for item in data:
            try:
                ...
                # Validate and convert to StockData
    ...
    def _import_futures(self, data: List[Dict[str, Any]]) -> None:
        ...
        for item in data:
            try:
                ...
                # Validate and convert to FutureData
                future_data = FutureData(**item)
    ...
    def _import_indices(self, data: List[Dict[str, Any]]) -> None:
        ...
        for item in data:
            try:
                ...
                # Validate and convert to IndexData
                index_data = IndexData(**item)
    ...
    def _import_options(self, data: List[Dict[str, Any]]) -> None:
        ...
        for item in data:
            try:
                ...
                # Validate and convert to OptionData
                option_data = OptionData(**item)
