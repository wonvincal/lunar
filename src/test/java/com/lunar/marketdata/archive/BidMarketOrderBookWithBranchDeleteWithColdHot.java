...
public final class BidMarketOrderBookWithBranchDeleteWithColdHot implements SingleSideMarketOrderBook {
	...
	public BidMarketOrderBookWithBranchDeleteWithColdHot(int bookDepth, SpreadTable spreadTable, int nullTickLevel, int nullPrice){
	...
	public void delete(int tickLevel, int price, int priceLevel){
		...
		if (topOfBookTickLevel - tickLevel <= this.bookDepth){
			delete(tickLevel);
		}
	}
