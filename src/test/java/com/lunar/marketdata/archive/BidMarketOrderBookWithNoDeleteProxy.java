...
public final class BidMarketOrderBookWithNoDeleteProxy implements SingleSideMarketOrderBook {
	...
	public BidMarketOrderBookWithNoDeleteProxy(int bookDepth, SpreadTable spreadTable, int nullTickLevel, int nullPrice){
	...
	private boolean delete(int tickLevel) {
	...
	private static boolean deleteNoop(int tickLevel){ return true;}
	...
	public void delete(int tickLevel, int price, int priceLevel){
		...
		boolean result = (topOfBookTickLevel - tickLevel > this.bookDepth) ? deleteNoop(tickLevel) : delete(tickLevel);
	}
