...
public final class BidMarketOrderBookWithBranchDelete implements SingleSideMarketOrderBook {
	...
	public BidMarketOrderBookWithBranchDelete(int bookDepth, SpreadTable spreadTable, int nullTickLevel, int nullPrice){
