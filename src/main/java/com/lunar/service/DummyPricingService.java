...
import com.lunar.service.PricingService.SecurityWrapper;
...
public class DummyPricingService implements ServiceLifecycleAware {
    ...
    private ExecutorService pricingExecutor = Executors.newSingleThreadExecutor();
    ...
    public static DummyPricingService of(final ServiceConfig config, final LunarService messageService){
        return new DummyPricingService(config, messageService);
    }
    
    public DummyPricingService(final ServiceConfig config, final LunarService messageService) {
