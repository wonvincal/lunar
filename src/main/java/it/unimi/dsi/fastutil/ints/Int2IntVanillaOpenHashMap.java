 ...
 * Use this if the size of this map is relatively big to the set of possible keys.
 * @author wongca
 *
 */
public class Int2IntVanillaOpenHashMap extends AbstractInt2IntMap implements java.io.Serializable, Cloneable, Hash {
	...
	public Int2IntVanillaOpenHashMap( final int expected, final float f ) {
	...
	public Int2IntVanillaOpenHashMap( final int expected ) {
	...
	public Int2IntVanillaOpenHashMap() {
	 ...
	 * @param f the load factor. */
	public Int2IntVanillaOpenHashMap( final Map<? extends Integer, ? extends Integer> m, final float f ) {
		this( m.size(), f );
		putAll( m );
	}
	 ...
	 *
	 * @param m a {@link Map} to be copied into the new hash map. */
	public Int2IntVanillaOpenHashMap( final Map<? extends Integer, ? extends Integer> m ) {
	 ...
	 * @param f the load factor. */
	public Int2IntVanillaOpenHashMap( final Int2IntMap m, final float f ) {
		this( m.size(), f );
		putAll( m );
	}
	 ...
	 *
	 * @param m a type-specific map to be copied into the new hash map. */
	public Int2IntVanillaOpenHashMap( final Int2IntMap m ) {
		this( m, DEFAULT_LOAD_FACTOR );
	}
	...
	public Int2IntVanillaOpenHashMap( final int[] k, final int[] v, final float f ) {
		this( k.length, f );
	 ...
	 * @param v the array of corresponding values in the new hash map.
	 * @throws IllegalArgumentException if <code>k</code> and <code>v</code> have different lengths. */
	public Int2IntVanillaOpenHashMap( final int[] k, final int[] v ) {
	...
	private class MapIterator {
		...
		boolean mustReturnNullKey = Int2IntVanillaOpenHashMap.this.containsNullKey;
		...
		public int nextEntry() {
			...
			final int key[] = Int2IntVanillaOpenHashMap.this.key;
			for ( ;; ) {
				if ( --pos < 0 ) {
		...
		public void remove() {
			...
			if ( last == n ) {
				...
				Int2IntVanillaOpenHashMap.this.remove( wrapped.getInt( -pos - 1 ) );
	...
	private final class MapEntrySet extends AbstractObjectSet<Int2IntMap.Entry> implements FastEntrySet {
		...
		public boolean contains( final Object o ) {
			...
			if ( ( ( k ) == ( 0 ) ) ) return ( Int2IntVanillaOpenHashMap.this.containsNullKey && ( ( value[ n ] ) == ( ( ( e.getValue() ).intValue() ) ) ) );
			int curr;
			final int[] key = Int2IntVanillaOpenHashMap.this.key;
			int pos;
			// The starting point.
		...
		public void clear() {
			Int2IntVanillaOpenHashMap.this.clear();
		}
	}
	...
	private final class KeySet extends AbstractIntSet {
		...
		public boolean remove( int k ) {
			...
			Int2IntVanillaOpenHashMap.this.remove( k );
			return size != oldSize;
		}
