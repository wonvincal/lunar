...
public class LunarAdminOnlyIT {
	private static final Logger LOG = LogManager.getLogger(LunarAdminOnlyIT.class);

	//@Test
	public void testUsingMain() throws UnsupportedEncodingException{
		...
		System.setProperty(LunarSystem.CONFIG_FILE_PROP, URLDecoder.decode(this.getClass().getClassLoader().getResource(Paths.get("config", "it", "simple", "lunar.admin.conf").toString()).getPath(), "UTF-8"));
